      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <!-- Add icons to the links using the .nav-icon class
               ...
               <li class="nav-item">
            <a href="<?php echo site_url('datapenjualan2/index') ?>" class="nav-link">
              ...
              <p>
               ...
               <li class="nav-item">
            <a href="<?php echo site_url('datatransaksi2/index') ?>" class="nav-link">
              <i class="nav-icon fas fa-cart-plus"></i>
              <p>
                Data Transaksi
              </p>
            ...
            <li class="nav-item">
              <a href="<?php echo site_url('laporan3/index') ?>" class="nav-link">
